...
public class StepAdapter extends RecyclerView.Adapter<StepAdapter.StepViewHolder>{
    ...
    public interface StepAdapterOnClickHandler {
        void onClick(int idStep, String description, String videoUrl);
    }

    class StepViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        @BindView(R.id.tv_short_description) TextView tvShortDescription;
        ...
        public void onClick(View view) {
            ...
            if (selectedItems.get(adapterPosition, false)) {
                ...
                flStepCardContainer.setSelected(false);
            }
            else {
            ...
            mClickHandler.onClick(mCursor.getPosition(),description,videoUrl);
        }
    }
}
